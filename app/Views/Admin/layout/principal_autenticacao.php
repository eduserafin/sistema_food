...
<head>
  <!-- Required meta tags -->
    ...
    <!--Essa section renderizará os estilos especificos da viw que estender esse layout -->
...
<body>
    <div class="container-scroller">
        ...
        <!--Essa section renderizará os conteudos especificos da viw que estender esse layout -->
    ...
    <!-- endinject -->
     ...
     <!--Essa section renderizará os scripts especificos da viw que estender esse layout -->
